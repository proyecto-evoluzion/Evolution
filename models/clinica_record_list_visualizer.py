...
class ClinicaRecordVisualizer(models.Model):
    ...
    def _get_post_anhestesic_ids(self, search_domain, doctor, start_period, end_period):
        post_anhestesic_ids = []
        post_anhestesic_search_domain = []
        post_anhestesic_search_domain.extend(search_domain)
        if doctor:
